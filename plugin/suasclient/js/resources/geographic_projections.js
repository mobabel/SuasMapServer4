...
/* geog2utm: converts geographic coordinates (latitude/longitude) to x and y UTM coordinates in the Universal Transverse Mercator projection
* added by Adrian Weber
*
* Inputs:
...
*
* Outputs and returns:
*	coords - A 2-element array containing the x and y UTM coordinates
*            of the given UTM zone, in metres
*/
function geog2utm(lat, lon, zone) {
	xy = new Array(2);
	...
	var coords = new Array();
	//rounds the coordinates to one digit after the comma
	coords["X"] = Math.round(xy[0]*10)/10;
	coords["Y"] = Math.round(xy[1]*10)/10;

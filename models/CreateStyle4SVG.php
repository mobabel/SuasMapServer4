 ...
 *For Linestring:$xmlSize,$xmlStrokeColor,$xmlStrokeOpacity,$xmlLineJoin,$xmlLineCap,$xmlFillOpacity
 ...
 */
function createStyle4SVG($layertype,$xmlSize,$xmlFillColor,$xmlStrokeColor,$xmlFont,
    ...
    switch($layertype){
		...
		case 'LINESTRING':{
		    if($xmlFillColor =="none"){
                $style4eachlayer = "fill:none;stroke-width:$xmlSize"."px;stroke:$xmlStrokeColor;".
			    "fill-opacity:$xmlStrokeOpacity;stroke-linejoin:$xmlLineJoin;stroke-linecap:$xmlLineCap";
			}
		    else
            $style4eachlayer = "fill:$xmlFillColor;fill-opacity:$xmlFillOpacity;stroke-width:$xmlSize"."px;stroke:$xmlStrokeColor;".
			"fill-opacity:$xmlStrokeOpacity;stroke-linejoin:$xmlLineJoin;stroke-linecap:$xmlLineCap";
			return $style4eachlayer;
		}break;
		case 'POLYGON':{
		    $style4eachlayer = "fill:$xmlFillColor;stroke-width:$xmlSize"."px;"."stroke:$xmlStrokeColor;".
			"fill-opacity:$xmlFillOpacity";
			return $style4eachlayer;
		...
		case 'UNKNOWN':{
		    $style4eachlayer = "fill:none;stroke-width:1"."px;stroke:#000000;".
			"fill-opacity:1";
			return $style4eachlayer;

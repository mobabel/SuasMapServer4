 ...
 * $image = new GDGradientFill($width,$height,$direction,$startcolor,$endcolor,$step);
 *
 * Parameters :
 ...
 * $image = new GDGradientFill(200,200,'horizontal','#fff','#f00');
 *
 * 2.
 * require_once('c:/iis/inet/include/gd-gradient-fill.php');
 * $myimg = new GDGradientFill(80,20,'diamond','#ff0010','#303060');
 *
 * edit by leelight
 */
...
// Test it :
//$image = new GDGradientFill(400,200,'ellipse','#f00','#000',0);

class GDGradientFill {
    public $image;

	// Constructor. Creates, fills and returns an image
	function GDGradientFill($w,$h,$d,$s,$e,$step=0) {
		$this->width = $w;
		$this->height = $h;
		$this->direction = $d;
		$this->startcolor = $s;
